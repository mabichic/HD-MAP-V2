...
import { confrimValueService } from './service/message.service';
...
export default function ConfirmValueDialog() {
  React.useEffect(() => {
    let subscription = confrimValueService.getMessage().subscribe(message => {
      if (message) {
